# copy pasted from https://github.com/facebookresearch/dino/blob/main/vision_transformer.py
...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=imagesize, patch_size=patchsize, in_chans=3, embed_dim=768):
        super().__init__()
...
class VisionTransformer(nn.Module):
    """ Vision Transformer """
    def __init__(self, img_size=[imagesize], patch_size=patchsize, in_chans=3, num_classes=0, embed_dim=768, depth=12,    # change image size from 224 to 32 for cifar
